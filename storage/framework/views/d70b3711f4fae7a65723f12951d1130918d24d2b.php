                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><?php echo app('translator')->get('Edit Employee'); ?></h4>
                        </div>
                        <div class="card-body">
                            <?php echo $__env->make('partials.errors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <form action="<?php echo e(route('employee.update',$model->id)); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-sm-12 mb-2">
                                        ...
                                        <input type="email" name="email" value="<?php echo e($model->email); ?>" class="form-control"
                                    ...
                                    <div class="col-xl-6 col-md-6 col-sm-12 mb-2">
                                        ...
                                        <img id="blah" alt="your image" width="100" height="100"  src="<?php echo e(asset('/storage/employee/'.$model->image)); ?>"  />
...
<?php echo $__env->make('layouts.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/kero/CS/Projects/Interviews Project/Task/resources/views/employees/edit.blade.php ENDPATH**/ ?>